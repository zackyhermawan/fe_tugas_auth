...
<template>
  <div class="min-h-screen w-full flex items-center justify-center bg-gray-100">
    <div class="w-full max-w-md p-8 bg-white rounded-xl shadow-lg border border-gray-100">
      ...
      <p class="text-center text-gray-500 mb-6 text-sm">Buat akun Anda secara instan</p>
      ...
      <form @submit.prevent="handleRegister" class="space-y-5">
        <div>
          <label class="block mb-1.5 text-sm font-medium text-gray-700">Username / Email</label>
          <input v-model="username" type="text" placeholder="Buat nama pengguna atau email" required
